...
int	main()
{
	...
	printf("strlcat, n=5 : %lu\nstrlcat, n=25 : %lu\n", strlcat(ex05_dest1, ex05_src1, 5), strlcat(ex05_dest2, ex05_src2, 18));
	printf("%s\n%s\n\n", ex05_dest1, ex05_dest2);
	printf("ft_strlcat, n=5 : %d\nft_strlcat, n=25 : %d\n", ft_strlcat(ex05_dest3, ex05_src3, 5), ft_strlcat(ex05_dest4, ex05_src4, 25));
	printf("%s\n%s\n\n", ex05_dest3, ex05_dest4);
